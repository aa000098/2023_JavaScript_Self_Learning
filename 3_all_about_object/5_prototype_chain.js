...
// __proto__는 모든 객체에 존재하는 프로퍼티
// class 강의에서 배울 때 상속에서 부모 클래스에서 해당되는 값이다.
 ...
 *  __proto__ === yuJin객체의 __proto__
 * 
 * IdolModel
 *  new === yuJin
 *  prototype === IdolModel.prototype.constructor
 *  __proto__ === yuJin.__proto__
 * 
 * yuJin 객체
 *  name
 *  year
 *  __proto__ === IdolModel.prototype
 */
...
// 상속 체인의 최상위에는 Object.prototype이 존재한다는 것을 알 수 있음
// 체인의 장점
